...
public class BlockIronCasing extends BlockBase implements ITileEntityProvider {

	public BlockIronCasing() {
		super(Material.rock);
		this.setBlockName(REF.NAME.BLOCK.ICasing);
		this.setBlockTextureName(REF.NAME.BLOCK.ICasing);
	...
	public TileEntity createNewTileEntity(World var1, int var2) {
		return new TileEntityIronCasing();
	}
